...
//        echo mysql_query("INSERT INTO p_followers (f_username,f_parent_user_id, f_run_time, f_status )VALUES ('$admin_followers[$j]','$user_row[parent_u_id]', '2012-07-21 19:40:10','4')");
    }
    ...
    for ($j = 0; $j < sizeof($user_followers); $j++) {
        ...
        try{
            echo mysql_query("INSERT INTO p_followers (f_username,f_parent_user_id, f_run_time, f_status )VALUES ('$username','$user_row[parent_u_id]', '$runtime','0')");
        }catch(Exception $e){
